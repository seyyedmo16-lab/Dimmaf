                            ...
                            <form action="{{ route('admin.blog.update',$blog->slug) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="mb-5 col-xl-12">
                                        ...
                                        <input type="text" name="title_en" class="form-control" placeholder="english title" value="{{$blog->title_en}}">
                                        @error('title_en')
                                    ...
                                    <div class="mb-5 col-xl-12">
                                        ...
                                        <input type="text" name="title_fa" class="form-control" placeholder="عنوان فارسی" value="{{$blog->title_fa}}">
                                        @error('title_fa')
                                            <div class="alert bg-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="col" id="states">
                                            ...
                                            <select  class="form-control" name="state_id" >
                                                @foreach ($states as $state)
                                                    <option value="{{$state->id}}" @if($state->id == $blog->state->id){{'selected'}} @endif>{{$state->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-5 col-xl-12">
                                        ...
                                        <textarea name="body_en" id="ckeditor_en" rows="20" class="form-control">{{$blog->body_en}}
                                            </textarea>
                                        @error('body_en')
                                            <div class="alert bg-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-5 col-xl-12">
                                        ...
                                        <textarea name="body_fa" id="ckeditor_fa" rows="20" class="form-control">{{$blog->body_fa}}
                                            </textarea>
                                        @error('body_fa')
                                            <div class="alert bg-danger">{{ $message }}</div>
                                        @enderror
