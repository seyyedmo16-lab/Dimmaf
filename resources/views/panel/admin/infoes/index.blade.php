                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($infoes as $info)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{$info->title_en ?? 'Empty'}}</td>
                                                        <td class="text-center">{{$info->title_fa ?? 'Empty'}}</td>
                                                        <td class="text-center">@if(empty($info->body_en))
                                                        ...
                                                        <td class="text-center"><a href="{{route('admin.info.edit', $info->id)}}" class="btn btn-success ps-5 pe-5">edit</a></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
